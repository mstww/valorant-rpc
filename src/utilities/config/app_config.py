...
default_config = {
    ...
    "presences": {
        "menu": {
            ...
            "button1": "Valorant Discord Bot",
            "link1": "https://discord.com/api/oauth2/authorize?client_id=640278989000146973&permissions=536602864752&scope=applications.commands%20bot",
